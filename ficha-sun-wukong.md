# Ficha de Personagem — Sun Wukong

**Imagem de referência:** `sunwukongaprovado.png`

## Descrição (DNA visual)
...
- **Caps. 1-2, antes da coroação**: sem coroa, veste só uma tanga/pano simples — ainda não tem figurino "oficial".
- **A partir da coroação (fim do Cap. 2)**: ganha a coroa dourada + o robe vermelho-alaranjado esfarrapado ("túnica curta") — esse figurino continua durante os Caps. 3-5.
- **A partir do Cap. 6**: troca pelo robe longo estilo quimono, mais elaborado, com faixa dourada — essa é a versão de referência oficial, usada pelo resto do livro.
- **Depois do Cap. 8** (forno mágico): os olhos ganham um brilho vermelho-dourado sutil — usar só nas cenas específicas onde isso é mencionado no texto (a saída do forno e cenas próximas).
- **Escala**: sempre o menor personagem em qualquer cena com humanos. Se precisar de destaque numa multidão, resolver por posição (elevado, primeiro plano), nunca aumentando o tamanho físico.
